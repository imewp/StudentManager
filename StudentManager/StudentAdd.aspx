                        ...
                        <div class="block-body">
                            <form class="form-horizontal" runat="server">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="rdlSexMale" type="radio" value="option1" name="a" class="radio-template"/>
                                        <label for="rdlSexMale" style="margin-right:50px;">男</label>
                                        <input id="rdlSexFemale" type="radio" checked="" value="option2" name="a" class="radio-template"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtStuAddress"  runat="server" placeholder="例：XX省XX市XX区XXXX街道XXX单元XXX号" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </form>
