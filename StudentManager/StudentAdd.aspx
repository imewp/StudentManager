<%@ Page Title="" Language="C#" MasterPageFile="~/Template.Master" AutoEventWireup="true" CodeBehind="StudentAdd.aspx.cs" Inherits="StudentManager.StudentAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="Home.aspx">首页</a></li>
            <li class="breadcrumb-item active">学生信息录入</li>
        </ul>
    </div>
                        ...
                        <div class="block-body">
                            <form class="form-horizontal" runat="server">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtStudentID" Width="450" runat="server" placeholder="账号不得长于20个字符" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtStudentPassword" Width="450" runat="server" placeholder="请输入6-16位的密码" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtStudentName" Width="450" runat="server" placeholder="姓名不得长于10个字" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">学生照片</label>
                                    <div class="col-sm-9">
                                        <asp:Image ID="Image1" runat="server" Width="150" Height="200"/>
                                        <asp:FileUpload ID="fulStudentPhoto" runat="server" />
                            ...
                            <br>
                                        <small class="text-primary">Normal Bootstrap elements</small></label>
                                    <div class="col-sm-9">
                                        <div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Checkboxes &amp; radios
                            <br>
                                        <small class="text-primary">Custom elements</small></label>
                                    <div class="col-sm-9">
                                        <div class="i-checks">
