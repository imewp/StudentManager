<%@ Page Title="" Language="C#" MasterPageFile="~/StudentTemplate.Master" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="StudentManager.NewsList" %>
                                ...
                                <div class="table-responsive">
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        ...
                                        <ItemTemplate>
                                            <tr class="gradeX">
                                                <td>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Eval("Title") %>' NavigateUrl='<%# Eval("Id", "~/NewsShowStu.aspx?id={0}")%>'></asp:HyperLink>
                                                </td>
                                                <td>
