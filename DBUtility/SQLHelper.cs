...
namespace DBUtility
{
    ...
    {
        //数据库连接
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["stud"].ConnectionString;
        ...
        /// <summary>
        /// Execute a 根据定制语句返回 a dateset query that will return a result set edit by lww 090308
        /// </summary>
